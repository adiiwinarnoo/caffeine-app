...
import 'package:flutter_caffeine/view/component/popup_rejected.dart';
...
class OrderNew extends StatelessWidget {
  ...
  const OrderNew({super.key,required this.typeOrder});

  @override
  Widget build(BuildContext context) {
    print('order type = ${typeOrder}');
    return Padding(
      padding: const EdgeInsets.only(left: 15.0,top: 10),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('새로 들어온 주문'),
          const SizedBox(height: 10),
          FutureBuilder<OrderProvider>(
            future: getOrder(context, ['ordered'],typeOrder),
                                              ...
                                              InkWell(
                                                ...
                                                onTap: (){
                                                  showDialog(context: context,
                                                      barrierDismissible: false, builder: (builder){
                                                    return PopupRejected(idProduct: result.id);
                                                  });
                                                },
                                              ),
